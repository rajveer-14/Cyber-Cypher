...
int main()
{
	...
	for (int i = 0; i < 16; i++) 
  {
	...
	inboxstatus++;
	cout<<"Your message has been successfully recorded!\n\n";}
	else if(option==2)
  {
        if(inboxstatus==0)cout<<"No new messages, be patient , great things take time.\n\n";
        else 
        {
            cout<<"Cipher text: "<<cipher<<"\n\n";
            cout<<"Decrypted text: "<<extra<<"\n\n";
            inboxstatus=0;
        }
    }
         }
    ...
    else cout<<"Self Destruction Sequence initiated :)...";
